...
process.stderr.write('A. baseline\n');
{
  ...
  check('A1 migrations = 16', mig.length === 16, `got ${mig.length}`);
  check('A2 0005 与 0016 均存在（P11/P16/P20/P21 迁移基线）', mig.some((n) => n.includes('0005')) && mig.some((n) => n.includes('0016')), mig.join(','));
