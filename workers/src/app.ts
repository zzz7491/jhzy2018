...
import subscriptions from './routes/subscriptions'; // N0-C：微信订阅授权（/api/v2/subscriptions/*；SELF，无发送）
...
export function createApp() {
  ...
  v2.route('/subscriptions', subscriptions); // N0-C：/api/v2/subscriptions/* 订阅授权（SELF；仅授权基础，无发送）
